              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="" id="nik" name="nik" class="form-control" placeholder="NIK" autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="" id="nuptk" name="nuptk" class="form-control" placeholder="NUPTK" autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="" id="nama_lengkap" name="nama_lengkap" class="form-control" placeholder="Nama Lengkap" autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="" id="jabatan" name="jabatan" class="form-control" placeholder="Jabatan" autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="" id="no_hp" name="no_hp" class="form-control" placeholder="No HP" autocomplete="off">
                  </div>
                </div>
              </div>
