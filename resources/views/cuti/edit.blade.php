              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="{{ $cuti->kode_cuti }}" id="kode_cuti" name="kode_cuti" readonly  class="form-control" placeholder="Kode Cuti">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="{{$cuti->nama_cuti}}" id="nama_cuti" name="nama_cuti" class="form-control" placeholder="Nama Cuti" autocomplete="off">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <span class="input-icon-addon">
                    ...
                    <input type="text" value="{{$cuti->jml_hari}}" id="jml_hari" name="jml_hari" class="form-control" placeholder="Jumlah Hari" autocomplete="off">
                  </div>
                </div>
              </div>
