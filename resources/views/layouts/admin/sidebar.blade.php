        ...
        <div class="container-fluid">
		   ...
		   data-bs-placement="bottom">
            ...
            <div class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                ...
                <a href="/prosesloginadmin" class="dropdown-item">Logout</a>
              </div>
            </div>
          </div>
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              <li class="nav-item">
                <a class="nav-link {{ request()->is('panel/dashboardadmin') ? 'active' : '' }}" href="/" >
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->is(['pendidik', 'departemen','madrasah']) ? 'show' : '' }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['pendidik', 'departemen','madrasah']) ? 'true' : '' }}" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
              ...
              <li class="nav-item dropdown {{ request()->is(['konfigurasi/lokasikantor', 'konfigurasi/*']) ? 'show' : '' }}">
                <a class="nav-link dropdown-toggle" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['konfigurasi/lokasikantor', 'konfigurasi/*']) ? 'true' : '' }}" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
