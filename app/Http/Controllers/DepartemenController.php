...
class DepartemenController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($simpan) {
            return Redirect::back()->with(['success' => 'Alhamdulillah, Data Baru Berhasil Disimpan']);
        } else {
            return Redirect::back()->with(['warning' => 'Ooops, Data Baru Gagal Disimpan']);            
        }
    }
    ...
    public function update($kode_dept, Request $request)
    {
        ...
        if($update) {
                ...
                return Redirect::back()->with(['warning' => 'Ooops, Data Gagal Diupdate']);
            }   
    }
