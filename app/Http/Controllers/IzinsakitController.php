...
class IzinsakitController extends Controller
{
    ...
    public function store(Request $request) 
    {
        ...
        if($simpan){
            ...
            return redirect('/presensi/izin')->with(['success'=>'Alhamdulillah, Data Ajuan Izin Sakit Berhasil Disimpan']);
        }else {
            return redirect('/presensi/izin')->with(['error'=>'Ooops, Data Ajuan Izin Sakit Gagal Disimpan']);
        }
    }
}
